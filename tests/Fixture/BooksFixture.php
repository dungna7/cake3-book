...
class BooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'summaryContent' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'name' => '78d33c8f-2c94-4576-a464-26edf9b6d149',
            'categoryId' => 1,
